...
-(void) loadParallaxBG{
    ...
    [_backgroundNode addChild:_planet z:-1 parallaxRatio:bgSpeed positionOffset:ccp(300, winSize.height * 0.3)];
    
    _starsEffect1 = [CCParticleSystemQuad particleWithFile:@"stars0.plist"];
    [self addChild:_starsEffect1 z:0];
    _starsEffect2 = [CCParticleSystemQuad particleWithFile:@"stars1.plist"];
    [self addChild:_starsEffect2 z:0.1];
    _starsEffect3 = [CCParticleSystemQuad particleWithFile:@"stars2.plist"];
    [self addChild:_starsEffect3 z:0.2];
